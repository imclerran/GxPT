namespace GxPT
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tblSettings.Controls.Add(this.lblMemoryEnabled, 0, 10);
            this.tblSettings.Controls.Add(this.chkMemoryEnabled, 1, 10);
            this.tblSettings.Controls.Add(this.lblMemoryMaxLines, 0, 11);
            this.tblSettings.Controls.Add(this.nudMemoryMaxLines, 1, 11);
            ...
            this.chkMemoryEnabled.Text = "Remember facts about this workspace (persistent project memory)";
